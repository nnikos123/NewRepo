        ...
        private IAsyncResult BeginInitStream(AsyncCallback asyncCallback)
        {
            ...
            switch (secureProtocol)
            {
                ...
                case (SslProtocols.Tls12):
                    SslStream ssl12Stream = CreateSslStream(certConfig);
                    result = ssl12Stream.BeginAuthenticateAsServer(AppSession.AppServer.Certificate, certConfig.ClientCertificateRequired, SslProtocols.Tls12, false, asyncCallback, ssl12Stream);
                    break;
